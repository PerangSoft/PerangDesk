...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the PerangDesk network..."),
        ...
        ("install_tip", "Due to UAC, PerangDesk can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install PerangDesk to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant PerangDesk \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant PerangDesk \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow PerangDesk to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [PerangDesk Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next PerangDesk application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant PerangDesk \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant PerangDesk \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running PerangDesk."),
        ...
        ("verify_perangdesk_password_tip", "Verify PerangDesk password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use PerangDesk and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_perangdesk_server_pro_to_{}_tip", "Please upgrade PerangDesk Server Pro to version {} or newer!"),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent PerangDesk from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by PerangDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if PerangDesk window is open"),
        ...
        ("floating_window_tip", "It helps to keep PerangDesk background service"),
        ...
        ("upgrade_remote_perangdesk_client_to_{}_tip", "Please upgrade the PerangDesk client to version {} or newer on the remote side!"),
