<p align="center">
  <img src="../res/logo-header.svg" alt="PerangDesk - Etätyöpöytäsi"><br>
...
PerangDesk toivottaa avustukset tervetulleiksi kaikilta. Katso lisätietoja [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) avun saamiseksi.
