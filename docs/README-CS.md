<p align="center">
  <img src="../res/logo-header.svg" alt="PerangDesk – vaše vzdálená plocha"><br>
...
Projekt PerangDesk vítá přiložení ruky k dílu od každého. Jak začít se dozvíte z [`docs/CONTRIBUTING.md`](CONTRIBUTING.md).
