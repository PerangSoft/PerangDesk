...
!define PRODUCT_NAME "PerangDesk"
...
Name "${PRODUCT_NAME}"
Outfile "perangdesk-${VERSION}-setup.exe"
...
Section "Install"
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT_NAME}" "Publisher" "Perang Rayaneh Ltd."
