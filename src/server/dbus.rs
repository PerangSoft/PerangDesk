...
///
/// Note:
/// On linux, we use dbus to communicate multiple perangdesk process.
...
const DBUS_NAME: &str = "org.perangdesk.perangdesk";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "PerangDesk DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.perangdesk.perangdesk /dbus org.perangdesk.perangdesk.NewConnection string:'PEER_ID'`
