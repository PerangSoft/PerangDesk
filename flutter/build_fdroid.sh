...
#
# Script to build F-Droid release of PerangDesk
#
# Copyright (C) 2024, The PerangDesk Authors
...
arm64-v8a)
	...
	PERANGDESK_FEATURES='flutter,hwcodec'
	;;
armeabi-v7a)
...
prebuild)
	...
	# Install Flutter version for PerangDesk library build
